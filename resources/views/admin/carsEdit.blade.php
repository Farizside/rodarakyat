      ...
      <div class="card-body px-3 pt-0 pb-2">
        ...
        <form action="/admin/cars/ {{ $cars->id }}" method="POST">
          ...
          <div class="form-group">
            ...
            <input name="price_fullday" type="number" class="form-control" id="price_fullday" value="{{$cars->price_fullday}}" placeholder="Enter Price Fullday">
          </div>
          <div class="form-group">
            <label for="price_halfday">Price Halfday</label>
            <input name="price_halfday" type="number" class="form-control" id="price_halfday" value="{{$cars->price_halfday}}" placeholder="Enter Price Halfday">
          </div>
          <div class="form-group">
